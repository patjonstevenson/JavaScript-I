...
//let carModels = inventory.map(car => car.car_model); //[car.car_model for car in inventory];
let carModelsSorted = inventory.map(car => car.car_model).sort();
...
let oldCars = carYears.filter(year => year <= 2001).length;
console.log(oldCars);
